...
function deleteTopping(toppingToDelete) {
  ...
  const updatedToppings = toppings.pizzaToppings.filter(topping => topping !== toppingToDelete);
  fs.writeFileSync(path.join(__dirname, "./data/pizzaToppings.json"), JSON.stringify(updatedToppings));
